...
#Add $UBUNTU_WEBSITE_DIR to the sumcoin-node-status.py script
echo "Add the distributions website dir to the sumcoin-node-status.py script"
...
echo "Add Sumcoin rpc user and password to the sumcoin-node-status.py script"
